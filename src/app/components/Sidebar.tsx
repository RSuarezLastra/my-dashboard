  ...
  return (
    <div id="menu" className="bg-gray-900 min-h-screen z-10 text-slate-300 w-[400px] left-0 h-screen overflow-y-scroll">
      ...
      <div id="nav" className="w-full px-6">
        <a href="#" className="w-full px-2 inline-flex space-x-2 items-center border-b rounded-md border-slate-700 py-3 bg-blue-800 hover:bg-white/5 transition ease-linear duration-150">
          <div>
        ...
        <a href="#" className="w-full px-2 inline-flex space-x-2 items-center border-b rounded-md border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
          <div>
